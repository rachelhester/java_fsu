...
public class StarbucksAdvanced {
	...
	public static void main (String args[])
	{
        ...
        while (!scnr.hasNextDouble()) {
            ...
            scnr.next();
            System.out.print("Please try again. Enter the current purchase amount: ");
    }
        ...
        System.out.print("Please enter the number of purchases in the last month: ");
            while (!scnr.hasNextInt()) {
			    ...
			    scnr.next();
			    System.out.print("Please try again. Enter number of purchases in the last month: ");
		}
        numPurchase = scnr.nextInt();
        System.out.println("*********************************");
        
    //checks if the purchase Total is at least $5 or doesn't qualify for discount
    //discount integers are changed into a discountFormat in the math section that converts them to decimals
    if (purchaseTotal >= 5) {
